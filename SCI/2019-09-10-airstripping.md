...
在保持温度和pH不变的情况下（323K，pH=10），提高气流流速明显提高NH<sub>3</sub>去除率，其主要通过影响相关参数如质量传递系数，混合方式和气液界面面积来实现，气流流速的增加能使反应容器中的气液接触更充分，进而提高质量传递面积，从而缩短吹脱所需时间，在2L/(min·L)气流流速下，去除95%NH<sub>3</sub>所需时间为24h，当提高气流流速至10L/(min·L)时，获得同等去除率时间缩短至4h以内。通过拟合\\(\frac{1}{K_L\times a}\\)与不同气流流速之间的关系曲线得图(c)，由图中可知，当气流流速由1增至4L/(min·L)时，质量传递阻力急剧减小，但再继续增加气流流速则变化不明显，这是因为高气流流速能够减少阻止尿液中NH<sub>3</sub>质量传递的界面层厚度。另外，在同等气流流速下，气泡大小也能通过影响质量传递系数而影响吹脱过程。
