...
在保持气流流速和pH不变下（4L/(min·L)，pH=10），升高温度由原来的室温296K至323K，NH<sub>3</sub>去除率从33%到95%，温度通过影响参数δ<sub>NH<sub>3</sub></sub>和(K<sub>L</sub>×a)来影响斜率，这是因为温度的升高能提高了NH<sub>3</sub>的分子扩散系数和亨利常数，进一步影响溶液中自由NH<sub>3</sub>的含量。

![](/assets/img/2019-09-28_125942.png)

**尿液稀释比例的影响**

在气体流速为2/(min·L)、温度323K、pH=10的条件下，研究尿液稀释比例为0，1/2，1/5，1/10对NH<sub>3</sub>去除率想影响， 结果表明，尿液稀释比例在上述恒定参数下对吹脱NH<sub>3</sub>影响不明显。

![](/assets/img/2019-09-29_223338.png)

**NH<sub>3</sub>去除率**

在不同运行条件下，基于双膜模型得到预估NH<sub>3</sub>去除率如图所示。较高的运行温度促进了吹脱过程，并且能够缩短达到特定NH<sub>3</sub>去除率的反应时间，较高的气流流速能够明显见底质量传递阻力，并且在某一特定温度下能够减少所需要的反应时间，另外，随着pH由9.3增加至10，运行时间大大缩短。

 ![](/assets/img/2019-09-29_224938.png)

**回收率**

吹脱出来的NH<sub>3</sub>由硫酸吸收，在不同温度下进行24h吹脱得到的NH<sub>3</sub>去除率及回收率如表所示。由表可得，回收率比吹脱率要低5-10%，这是因为：⑴NH<sub>3</sub>在pH调节时部分挥发；⑵高气流流速造成的NH<sub>3</sub>损失；⑶吹脱后的NH<sub>3</sub>在到达酸罐前被吹脱塔内的冷凝水（吹脱气体由塔内高温到环境室温形成的）吸收。

 ![](/assets/img/2019-09-29_230249.png)
